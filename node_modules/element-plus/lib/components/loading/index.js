...
function createLoadingComponent({
  ...
  const data = vue.reactive(__spreadProps(__spreadValues$1({}, options), {
    originalPosition: "",
    originalOverflow: "",
    visible: false
  }));
  ...
  const componentSetupConfig = __spreadProps(__spreadValues$1({}, vue.toRefs(data)), {
    setText,
    close,
    handleAfterLeave
  });
  const elLoadingComponent = {
    ...
    render() {
      const spinner = vue.h("svg", __spreadValues$1({
        class: "circular",
...
const addStyle = (options, parent, instance) => __async(undefined, null, function* () {
  ...
  if (options.fullscreen) {
    ...
    maskStyle.zIndex = PopupManager__default['default'].nextZIndex();
