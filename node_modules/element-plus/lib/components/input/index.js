...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    _ctx.type !== "textarea" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
      ...
      _ctx.getSuffixVisible() ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4, [
    ...
    _ctx.isWordLimitVisible && _ctx.type === "textarea" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_10, vue.toDisplayString(_ctx.textLength) + "/" + vue.toDisplayString(_ctx.maxlength), 1)) : vue.createCommentVNode("v-if", true)
  ], 38);
}
