...
var script$1 = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    formMitt.on(tokens.elFormEvents.addField, (field) => {
      if (field) {
        fields.push(field);
      }
    });
    formMitt.on(tokens.elFormEvents.removeField, (field) => {
      if (field.prop) {
    ...
    const elForm = vue.reactive(__spreadValues$1(__spreadProps$1(__spreadValues$1({
      formMitt
    }, vue.toRefs(props)), {
      resetFields,
      clearValidate,
...
var script = vue.defineComponent({
  ...
  setup(props, { slots }) {
    ...
    vue.onMounted(() => {
      var _a;
      if (props.prop) {
        (_a = elForm.formMitt) == null ? void 0 : _a.emit(tokens.elFormEvents.addField, elFormItem);
        const value = fieldValue.value;
    ...
    vue.onBeforeUnmount(() => {
      var _a;
      (_a = elForm.formMitt) == null ? void 0 : _a.emit(tokens.elFormEvents.removeField, elFormItem);
    });
...
script$1.FormItem = script;
const _Form = script$1;
const ElForm = _Form;
const ElFormItem = script;
