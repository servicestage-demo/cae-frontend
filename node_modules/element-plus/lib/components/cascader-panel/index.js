...
var ElCheckbox = require('../checkbox');
var ElRadio = require('../radio');
...
const _hoisted_2$1 = /* @__PURE__ */ vue.createElementVNode("span", null, null, -1);
const _hoisted_3 = {
  key: 2,
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("li", {
    ...
    _ctx.multiple ? (vue.openBlock(), vue.createBlock(_component_el_checkbox, {
      ...
      _: 1
    }, 8, ["model-value", "label", "disabled", "onUpdate:modelValue"])) : _ctx.isLeaf && _ctx.node.checked ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_3)) : vue.createCommentVNode("v-if", true),
    ...
    !_ctx.isLeaf ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 3 }, [
      _ctx.node.loading ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_4)) : (vue.openBlock(), vue.createElementBlock("i", _hoisted_5))
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(_component_el_scrollbar, {
    ...
    default: vue.withCtx(() => [
      ...
      _ctx.isEmpty ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, vue.toDisplayString(_ctx.t("el.cascader.noData")), 1)) : _ctx.panel.isHoverMenu ? (vue.openBlock(), vue.createElementBlock("svg", _hoisted_2, null, 512)) : vue.createCommentVNode("v-if", true)
    ]),
    _: 1
...
class Node {
  ...
  get isLeaf() {
    ...
    return util.isUndefined(isLeaf) ? lazy && !loaded ? false : !Array.isArray(childrenData) : !!isLeaf;
  }
  get valueByOption() {
...
const useCascaderConfig = (props) => {
  return vue.computed(() => __spreadValues$1(__spreadValues$1({}, DefaultProps), props.props));
};
