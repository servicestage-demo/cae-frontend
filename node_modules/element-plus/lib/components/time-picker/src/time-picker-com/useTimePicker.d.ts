...
export declare const useOldValue: (props: {
    ...
    diff: (date?: string | number | Date | Dayjs, unit?: "M" | "y" | "s" | "week" | "year" | "weeks" | "months" | "month" | "date" | "dates" | "day" | "hour" | "minute" | "second" | "millisecond" | "hours" | "minutes" | "seconds" | "milliseconds" | "days" | "years" | "d" | "h" | "m" | "ms" | "w" | "quarter" | "quarters" | "Q", float?: boolean) => number;
    valueOf: () => number;
    unix: () => number;
    daysInMonth: () => number;
    toDate: () => Date;
