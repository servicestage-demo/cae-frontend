...
script$4.Aside = script$3;
script$4.Footer = script$2;
script$4.Header = script$1;
script$4.Main = script;
const _Container = script$4;
const ElContainer = _Container;
const ElAside = script$3;
const ElFooter = script$2;
const ElHeader = script$1;
const ElMain = script;

export { ElAside, ElContainer, ElFooter, ElHeader, ElMain, _Container as default };
