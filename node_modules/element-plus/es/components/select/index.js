import { inject, computed, getCurrentInstance, watch, onBeforeUnmount, defineComponent, reactive, toRefs, withDirectives, openBlock, createElementBlock, normalizeClass, withModifiers, renderSlot, createElementVNode, toDisplayString, vShow, ref, onMounted, normalizeStyle, nextTick, provide, resolveComponent, resolveDirective, createVNode, withCtx, createBlock, createCommentVNode, Transition, Fragment, renderList, withKeys, vModelText, createSlots } from 'vue';
...
script$1.Option = script$3;
script$1.OptionGroup = script;
const _Select = script$1;
const ElSelect = _Select;
const ElOption = script$3;
const ElOptionGroup = script;

export { ElOption, ElOptionGroup, ElSelect, _Select as default, selectEvents, selectGroupKey, selectKey };
