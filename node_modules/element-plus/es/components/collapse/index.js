import { defineComponent, ref, watch, onUnmounted, provide, openBlock, createElementBlock, renderSlot, inject, computed, resolveComponent, normalizeClass, createElementVNode, withKeys, withModifiers, createTextVNode, toDisplayString, createVNode, withCtx, withDirectives, vShow } from 'vue';
...
script$1.CollapseItem = script;
const _Collapse = script$1;
const ElCollapse = _Collapse;
const ElCollapseItem = script;

export { ElCollapse, ElCollapseItem, _Collapse as default };
